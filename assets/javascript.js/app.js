...
var play= function(userChoice){
    ...
    document.getElementById("oppenent").innerHTML="";
...
if(userChoice=="rock" || userChoice=="paper"|| userChoice=="scissors" ){
    ...
    document.getElementById("player").innerHTML="you chose" + ' ' + userChoice + ' Well, you lost.';
...
var compare = function(choice1,choice2) {
    ...
    return "rope FTW";
        ...
        return"error , game over , no dice";
    }
};
...
if (wins> 999){
    alert ("You reached the max score of 999. Congratuations, life lost.")
    }

if (loses >999){
    alert ("you opponent reached the max score of 999.We are sorry , you dont have life.");
}
};
